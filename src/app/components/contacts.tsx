...
export default function Contacts() {
    return (
        <div id="socials" className='w-[80%] sm:w-[600px] md:w-[780px] h-[20%] sm:h-[90px] bg-gradient-to-b dark:from-slate-800/5 dark:to-slate-800/95 from-slate-400/5 to-slate-600 rounded-2xl shadow-2xl flex items-center justify-evenly mb-9'>
