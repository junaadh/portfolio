...
export default function Intoduction() {
    return (
        <div id="container" className='p-4  w-[80%] sm:w-[600px] md:w-[780px] h-[80%] sm:h-[500px] bg-gradient-to-br from-black via-slate-800 to bg-gray-800 rounded-2xl shadow-2xl flex flex-col items-center justify-center'>
